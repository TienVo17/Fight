    ...
    ITenantManagementDbContext
{
    ...
    public DbSet<Producter> Products { get; set; }
    ...
    public DbSet<PromotionUsageHistory> PromotionUsageHistorys { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new ProductAtrributeConfiguration());
